...
<form name="frmDelete" action="{{ route('pedidos.destroy', $pedido->id)}}" method="post" onsubmit="return confirm('Confirma a exclusão do produto?');">
    <a href="{{route('pedidos.edit', $pedido->id)}}"><input class="btn btn-secondary" type="button" value="Editar"></a>
